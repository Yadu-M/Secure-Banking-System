...
#         root, text=f"Account has been successfully registered with Username: {user}"
#     )
...
#     username_label, username_entry, password_label, password_entry, login_button
# ):
...
#             root,
#             text="User with this username or password is not found.\nIf you don't have an account, please register.",
#         )
...
#             root,
#             text="Register",
#             command=lambda: on_register(username_entry, password_entry),
#         )  # command=on_register(username_entry, password_entry)
...
#             root,
#             text="Try again",
#             command=lambda: show_login_widgets(
#                 username_label,
#                 username_entry,
#                 password_label,
#                 password_entry,
